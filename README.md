...
- [**Participant Dropout Classification**](https://github.com/hnstaggs/Participant-Dropout-Classification) - Classified drop out using demographic features. Identify subpopulations likely to drop out of data collection prematurely. 
